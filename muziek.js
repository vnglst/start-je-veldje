...
const mainMelody = [
    { note: "C4", duration: "8n" }, { note: "E4", duration: "8n" },
    { note: "G4", duration: "8n" }, { note: "C5", duration: "4n" },
    { note: "B4", duration: "8n" }, { note: "A4", duration: "8n" },
    { note: "G4", duration: "4n" }, { note: "F4", duration: "8n" },
    { note: "E4", duration: "8n" }, { note: "D4", duration: "8n" },
    { note: "C4", duration: "4n" }, { note: "E4", duration: "8n" },
    { note: "G4", duration: "8n" }, { note: "A4", duration: "4n" },
    { note: "G4", duration: "8n" }, { note: "F4", duration: "8n" },
    { note: "E4", duration: "2n" }
];
const mainBass = [
